        ...
        {loading ? (
          ...
          <ul className="space-y-4">
            {notifications.map((notification, index) => (
              <li
                key={index}
                className="bg-red-800 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border border-red-700 flex items-center space-x-4 cursor-pointer hover:shadow-xl transition"
              >
                <p>
